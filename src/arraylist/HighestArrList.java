...
public class HighestArrList {
    /*
    Take 5 numbers like 100,200,300,400,500 and write a program to find the highest value from those number? use Array and ArrayList format
    */
...
// Output the highest value
    ...
    public static void highestArraylist(){
